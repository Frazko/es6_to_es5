...
window.exp23a.signUp.abcss = `<style>
    ...
    @media screen and (min-width: 768px) {
        ...
        .nut-holder{
            ...
            width: 110%;
            height: 110%;
            background-image: url(//cdn.optimizely.com/img/537950227/d672fd027cf44d5bb65622d3dbbb8d7a.png);
            background-size: 466px;
            background-repeat: no-repeat;
            background-position: 235px 145px;
            z-index: 0;
        }
        #signUpWhite .nut-holder{
            position: absolute;
            top: 160px;
            width: 110%;
            height: 110%;
...
window.exp23a.signIn.abcss = `<style>
    ...
    @media screen and (min-width: 768px) {
        ...
        #signInWhite #signInWhite_btnSubmit, #signInWhite .noAccount {
            margin-top: 20px;
            text-align: center;
        }
